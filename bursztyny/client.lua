...
Citizen.CreateThread(function()
	...
	AddTextComponentString('Szukanie bursztynow')
	...
	BeginTextCommandSetBlipName('STRING')
	AddTextComponentString('Mycie bursztynow')
	...
	BeginTextCommandSetBlipName('STRING')
	AddTextComponentString('Sprzedawanie bursztynow')
	...
	BeginTextCommandSetBlipName('STRING')
	AddTextComponentString('Szlifowanie bursztynów')
