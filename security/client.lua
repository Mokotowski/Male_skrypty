...
RegisterCommand("security", function (cooldown)
...
function OpenPoliceBackupMenu()
  ...
  'default', GetCurrentResourceName(), 'securitymenu',
  {
    ...
    elements = {
      {label = '👮 Eskorta (1)', value = 'spawn'},	
      {label = '👮 Eskorta (2)', value = 'spawn2'},  
      {label = '🔫 Daj broń', value = 'giveweapons'},
      {label = '🗡️ Atakuj najbliższą osobę', value = 'playerattack'},
      {label = '🚘 Napraw pojazdy eskorty', value = 'fix'},
      {label = '🛫 Patrol', value = 'wander'},
      {label = '🔊 Eskortowanie', value = 'follow'},
      {label = '🗑️ Usuń eskorte', value = 'delete'},
      {label = '⬅️ Zamknięcie menu', value = 'exit'},
    }
  },
  ...
  function(data, menu)
    if data.current.value == 'spawn' then
      ...
      cooldown = 600
        ...
        ESX.ShowNotification("Muisz odczekać: ".. cooldown.. " sekund aby kolejny raz skorzystać ze wsparcia")
