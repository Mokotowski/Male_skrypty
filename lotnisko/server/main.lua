...
ESX.RegisterServerCallback('lotcayoplatnosc', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	
	if xPlayer.getMoney() >= 5000 then
		xPlayer.removeMoney(5000)
		TriggerClientEvent("txt123", source)
		TriggerClientEvent("swt_notifications:Success",source,"Lotnisko","Pomyślnie zakupiłeś bilet za: 5000$","top-right",1500,true)
		
	else
		TriggerClientEvent("swt_notifications:Negative", source, "Lotnisko","Niestety nie posiadasz wystarczającej ilości gotówki","top-right",1500,true)
	end
