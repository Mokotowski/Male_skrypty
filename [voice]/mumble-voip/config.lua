...
mumbleConfig = {
    ...
    voiceModes = {
        {2.5, "Szept"}, -- Whisper speech distance in gta distance units
        {8.0, "Normalny"}, -- Normal speech distance in gta distance units
        {20.0, "Krzyk"}, -- Shout speech distance in gta distance units
    },
