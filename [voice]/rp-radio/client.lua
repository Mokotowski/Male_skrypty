...
Radio.Labels = {        
    { "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Input.Name .. "~") .. " Opcje.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ aby włączyć ~g~radio~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ albo ~" .. radioConfig.Controls.Increase.Name .. "~ aby zmienić częstotliwość~n~~" .. radioConfig.Controls.Input.Name .. "~ aby wybrać częstotliwość~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ aby ~a~ kliknięcia mikrofonu~n~Częstotliwość: ~1~ MHz" },
    { "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Input.Name .. "~") .. " Opcje.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ aby wyłączyć ~r~radio~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ aby gadać.~n~Częstotliwość: ~1~ MHz" },
    { "FRZL_RADIO_INPUT", "Wprowadź częstotliwość" },
}
Radio.Commands = {
    {
        Enabled = false, -- Add a command to be able to open/close the radio
        Name = "radio", -- Command name
        Help = "Użyj radia", -- Command help shown in chatbox when typing the command
        Params = {},
    ...
    },
    {
        ...
        Name = "radio", -- Command name
        Help = "Zmień częstotliwość radiową", -- Command help shown in chatbox when typing the command
        Params = {
            {name = "numer", "Wprowadź częstotliwość"}
        },
        Handler = function(src, args, raw)
            if Radio.Has then
                if args[1] then
