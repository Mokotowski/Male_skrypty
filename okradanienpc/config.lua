...
Config.MinMoney = 800                 --  Min amount of money received from mugging
Config.MaxMoney = 1500               --  Max amount of money received from mugging.
...
Config.AddItemsMax = 5              --  This is the max number of items you can receive from NPC from mugging - min is 1
