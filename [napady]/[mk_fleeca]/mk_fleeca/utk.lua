...
UTK.maxcash = 1140 -- maximum amount of cash a pile can hold
UTK.mincash = 900 -- minimum amount of cash a pile holds
UTK.black = false -- enable this if you want blackmoney as a reward
UTK.cooldown = 3600 -- amount of time to do the heist again in seconds (15min)
