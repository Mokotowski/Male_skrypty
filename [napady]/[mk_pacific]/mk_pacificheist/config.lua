...
Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. Also dont forget glass cutting and painting item names.(in bottom)
        {itemName = 'gold', sellPrice = 1500},
        {itemName = 'diamond', sellPrice = 2000},
        {itemName = 'coke_pooch', sellPrice = 1000},
    },
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(2404.87, 3138.61, 48.16),
        peds = {
            {pos = vector3(2403.1, 3138.13, 48.15), heading = 253.22, ped = 's_m_m_highsec_01'},
            {pos = vector3(2404.36, 3140.0, 48.15), heading = 184.78, ped = 's_m_m_highsec_02'},
            {pos = vector3(2405.9, 3139.701, 48.15), heading = 128.42, ped = 's_m_m_fiboffice_02'}
        }
    },
    ['finishHeist'] = {
...
Strings = {
    ['e_start'] = 'Naciśnij ~INPUT_CONTEXT~ aby zacząć napad na Pacyfica',
    ['start_heist'] = 'Jedź do Banku Pacyfic',
    ['start_heist2'] = 'Potrzebujesz: Laptop, Hack USB, Przecinak, Termit, Torbę, Wiertło',
    ['plant'] = 'Naciśnij ~INPUT_CONTEXT~ by podłożyć termit',
    ['plant_bomb'] = 'Naciśnij ~INPUT_CONTEXT~ by podłożyć C4',
    ['detonate_bombs'] = 'Naciśnij ~INPUT_CONTEXT~ By zdetonować bomby',
    ['grab'] = 'Naciśnij ~INPUT_CONTEXT~ by zbierać',
    ['hacking'] = 'Podejdź bliżej terminala',
    ['vault'] = 'Naciśnij ~INPUT_CONTEXT~ by otworzyć skarbiec',
    ['drill'] = 'Naciśnij ~INPUT_CONTEXT~ by UŻYĆ wiertło',
    ['wait_nextrob'] = 'Muisz czekać by zacząć napad na nowo',
    ['minute'] = 'minuty.',
