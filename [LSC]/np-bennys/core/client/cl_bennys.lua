...
local bennyLocation = vector3(-34.73, -1052.34, 28.4)
            ...
            if PlayerData.job ~= nil and PlayerData.job.name == 'mecano' then
                ...
                if nearDefault then
                    ...
                    if nearDefault then
                        ...
                        Draw3DText(bennyLocation.x, bennyLocation.y, bennyLocation.z + 0.5, "[Nacisnij ~p~E~w~ - aby otworzyc White Customs]", 255, 255, 255, 255, 4, 0.45, true, true, true, true, 0, 0, 0, 0, 55)
