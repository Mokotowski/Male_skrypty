...
Config.Zones = {
  MecanoActions = {
    Pos   = { x = -36.35, y = -1069.93, z = 28.4 }, -- -1.55 -1658.03 29.48
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -20.0, y = -1029.19, z = 29.93 },
    Size  = { x = 0.5, y = 0.5, z = 0.5},
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -29.79, y = -1025.64, z = 28.85 },
    Size  = { x = 0.5, y = 0.5, z = 0.5},
    Color = { r = 0, g = 255, b = 255 },
    Type  = -1,
  },
