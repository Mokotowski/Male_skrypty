...
Config.NPCJobEarnings             = {min = 800, max = 1200}
...
Config.Zones = {
	...
	TaxiActions = {
		Pos     = {x = 895.19, y = -172.09, z = 73.680},
	...
	VehicleSpawnPoint = {
		Pos  = { x = 901.43, y = -146.0, z = 76.56, heading = 322.98, radius = 6.0 },
		Size = {x = 1.5, y = 1.5, z = 1.0},
		Type = -1
	},

	VehicleDeleter = {
		Pos   = {x = 899.37, y = -188.47, z = 72.888},
