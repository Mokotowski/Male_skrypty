Locales['pl'] = {
  ...
  --dzwonek
  ['pageFloatingText']   = "Naciśnij ~b~E~s~ aby wezwać ~b~LSPD ~w~na recepcje",
  ['notificationText'] = "^5Uwaga, LSPD ^0zostało wezwane na ^3Recepcję ^5%s^7 ",
  ['successfulPage'] = "Wezwałeś LSPD, czekaj..",
  ['recentPage'] = "Wzywałeś nie dawno LSPD musisz poczekać!",
}
