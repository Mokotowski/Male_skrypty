            ...
            for mechanicIndex, pedData in ipairs(Heap.Peds) do
                ...
                if DoesEntityExist(pedHandle) then
                    ...
                    if dstCheck <= 1.4 then
                        ...
                        local displayText = usable and "Kliknij ~INPUT_CONTEXT~ aby porozmawiać z ~y~" .. mechanic.Name .. "~s~." or IsEntityDead(pedHandle) and "~y~" .. mechanic.Name .. "~s~ nie żyje! Na chuj go zajebałeś?" or "~y~" .. mechanic.Name .. "~s~ naprawia pojazd."
