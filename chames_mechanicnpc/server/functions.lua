...
CheckRepairs = function()
    for mechanicName, repairData in pairs(Heap.Mechanics) do
        ...
        if minutesPassed > Default.RepairTime then
            ...
            TriggerClientEvent("james_mechanicnpc:repairDone", sourcePlayer and sourcePlayer.source or randomPlayer, mechanicName, repairData, sourcePlayer and true or false)
            TriggerClientEvent("james_mechanicnpc:updateSequence", -1, mechanicName, repairData, #RepairSequences)
        ...
        elseif minutesPassed > Default.RepairTime / (#RepairSequences - 1) * (repairData.Sequence or 1) then
            ...
            TriggerClientEvent("james_mechanicnpc:updateSequence", -1, mechanicName, repairData, repairData.Sequence)
...
UpdateRepairs = function()
    TriggerClientEvent("james_mechanicnpc:updateRepairs", -1, Heap.Mechanics)
end